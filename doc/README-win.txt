...
In the binary release of Trigger Rally, the contents of the "data" folder are
distributed in a .ZIP file named "data.zip". Apparently the game files will
load faster if they are stored in an uncompressed .ZIP archive.
